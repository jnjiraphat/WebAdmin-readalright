...
const EditArticle = () => {
  ...
  async function editContent() {
    ...
    console.log(match.params.readingId)
    const result = await axios("https://readalright-backend.khanysorn.me/reading/readingId/" + match.params.readingId);
    console.log("result")
  ...
  async function postReading(
    ...
    const response = await axios.put("https://readalright-backend.khanysorn.me/reading/" + match.params.readingId, {
      title: title,
      content: content,
      image: image,
